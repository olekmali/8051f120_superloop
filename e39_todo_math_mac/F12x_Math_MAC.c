...
// int16_t mul = ?C?IMUL_F120 routine
// uint16_t mul = ?C?IMUL_F120 routine
// signed int32_t mul = ?C?LMUL_F120 routine
// uint32_t mul = ?C?LMUL_F120 routine
// signed int32_t shift left = ?C?LSHL_F120 routine
// uint32_t shift left = ?C?LSHL_F120 routine
// signed int32_t shift right = ?C?ULSHR_F120 routine
// uint32_t shift right = ?C?SLSHR_F120 routine
...
void main (void)
{
   ...
   uint16_t u_multiplier, u_multiplicand, u_product;

   // 16-bit Signed Multiply
   int16_t multiplier, multiplicand, product;

   // 32-bit Unsigned Multiply
   uint32_t ul_multiplier, ul_multiplicand, ul_product;

   // 32-bit Signed Multiply
   int32_t l_multiplier, l_multiplicand, l_product;

   // Random Generator Operations
   uint32_t ulrand1, ulrand2;
   int32_t lrand1, lrand2;
   uint8_t shifts;
