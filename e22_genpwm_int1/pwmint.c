...
//  TMR4CF  = 0x08;                     // use SYSCLK as timebase
    RCAP4   = (uint16_t)(65536UL - counts); // Timer reload values
...
void Timer4_PWM_ISR (void) __interrupt 16 __using 3
{
    ...
    SFRPAGE = TMR4_PAGE;                // set the SFR page to allow access to the necessary SFRs to access Timer4 related SFRs
